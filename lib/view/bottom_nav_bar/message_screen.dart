...
import 'package:eventrra/view/chat/chat_room_screen.dart';
                  ...
                  child: Obx(
                    () => ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          try {
                            image = dataController.filteredUsers[index]
                                .get('image');
                          } catch (e) {
                            image = '';
                          }
                          ...
                          String fcmToken = '';
                          try {
                            fcmToken = dataController.filteredUsers[index]
                                .get('fcmToken');
                          } catch (e) {
                            fcmToken = '';
                          }

                          return dataController.filteredUsers[index].id ==
                              ...
                              : InkWell(
                                  onTap: () {
                                    ...
                                    if (myUid.hashCode >
                                        dataController
                                            .filteredUsers[index].id.hashCode) {
                                      chatRoomId =
